...
export class DetailComponent implements OnInit {
    ...
    this.cartService
      ...
      .subscribe(
        (res) => {
          ...
          Swal.fire('Added !!','Product has been added to cart','info');
  ...
  handleAddToWishList(productId) {
    this.cartService.addToWishList(productId).subscribe(() => {
      ...
      Swal.fire('Added !!',  'Product has been added to Wishlist','info');
    });
  }
  ...
  handleRemoveFromWishList(productId) {
    this.wishListService.removeFromWishList(productId).subscribe(() => {
      ...
      Swal.fire('Removed !!',  'Product has been removed to Wishlist','warning');
    });
  }
}
